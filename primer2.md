...
The <code>valueConstraint</code> further defines rules for the value node type value type that has been associated with the property. Where the <code>valueConstraint</code> 
